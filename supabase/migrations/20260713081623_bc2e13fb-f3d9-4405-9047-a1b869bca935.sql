-- Grant Data API access to authenticated role on public tables that were missing GRANTs.
-- Without these, RLS policies alone are not enough; PostgREST returns permission denied.
DO $$
DECLARE
    tbl record;
    has_priv boolean;
